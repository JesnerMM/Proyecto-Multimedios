  ...
  return (
    <section ref={orderRef} className="py-12 bg-primary text-white-1">
      <div className="container mx-auto px-4 text-center">
        <h2 className={`text-2xl font-bold mb-6 ${orderVisible ? 'animate__animated animate__fadeInDown' : 'opacity-0'}`}>
          ¿Listo para ordenar?
        </h2>
        <p className={`text-lg mb-8 max-w-2xl mx-auto ${orderVisible ? 'animate__animated animate__fadeInUp' : 'opacity-0'}`}>

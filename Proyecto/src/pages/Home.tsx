        ...
        <div className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 z-20 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              <span className="font-playfair text-white">Donde </span>
              <span className="font-dancing text-[#FFD700]">Carla</span>
            </h1>
            ...
            <div className="flex flex-row justify-center gap-4">
              <Link
                to="/menu"
                className="flex items-center justify-center bg-[#8B6F47] hover:bg-[#9d8259] text-white font-medium text-sm py-2.5 px-4 rounded-md w-40 text-center"
              >
                Ver Menú
              </Link>
              <WhatsAppButton className="w-48 text-sm py-2.5 px-4" />
            </div>
          </div>
        </div>
      </section>

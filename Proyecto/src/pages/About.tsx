  ...
  return (
    <div className="w-full bg-background-white">
      ...
      <section className="relative bg-[#2D1B14] text-white">
        ...
        <div className="relative h-[50vh] md:h-[35vh] flex items-center justify-center overflow-hidden">
          <img
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div ref={nuestraHistoriaRef} className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className={`text-3xl font-bold text-primary mb-4 ${nuestraHistoriaVisible ? 'animate__animated animate__fadeInLeft' : 'opacity-0'}`}>
                Nuestra Historia
              </h2>
              <p className={`text-white-2 mb-4 ${nuestraHistoriaVisible ? 'animate__animated animate__fadeInLeft' : 'opacity-0'}`}>
      ...
      <section className="py-16 bg-background-beige">
        <div className="container mx-auto px-4">
          <div className={`text-center mb-12 ${misionVisible ? 'animate__animated animate__fadeIn' : 'opacity-0'}`}>
            ...
            <p className="text-white-2 max-w-3xl mx-auto">
              ...
              <ul className="space-y-2">
                {values.map((value, index) => (
                  <li key={index} className="flex items-start">
                    ...
                    <span className="text-white-2">{value}</span>
                  </li>
                ))}
              </ul>
            </div>
